...
val md_theme_light_surfaceTint = Color(0xFFBA1A1A)
...
val md_theme_dark_onSecondary = Color(0xFF5F1510)
...
val md_theme_dark_inversePrimary = Color(0xFFBA1A1A)
